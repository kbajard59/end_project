...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextEditorField::new('deliveryAddress','Adresse de livraison')->onlyOnDetail(),
            MoneyField::new('total','Total produit')->setCurrency('EUR'),
            TextField::new('deliveryName','Mode de livraison'),
            MoneyField::new('deliveryPrice','Frais de port')->setCurrency('EUR'),
